...
Avant BookWyrm 0.5.4, des images de prévisualisation étaient générées pour les comptes externes. As it was wasteful in terms of disk space and computing power, that generation has been stopped. Si vous souhaitez supprimer en masse toutes les images précédemment générées pour les comptes distants, une nouvelle commande a été ajoutée :
