BookWyrm utilitza el protocol [ActivityPub](http://activitypub.rocks/) per enviar i rebre l'activitat dels usuaris entre altres instàncies de BookWyrm i altres serveis que implementen ActivityPub, com [Mastodon](https://joinmastodon.org/). To handle book data, BookWyrm has a handful of extended Activity types which are not part of the standard, but are legible to other BookWyrm instances.
