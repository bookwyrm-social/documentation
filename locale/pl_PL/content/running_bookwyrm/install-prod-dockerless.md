...
- Install dependencies. W systemie Debian może to wyglądać następująco: `apt install postgresql redis nginx python3-venv python3-pip python3-dev libpq-dev`
...
- Configure nginx
    ...
    - Update nginx `bookwyrm.conf`:
        ...
        - Usuń znacznik komentarza w wierszach od 18 do 67, aby włączyć przekierowanie HTTPS. You should have two `server` blocks enabled
