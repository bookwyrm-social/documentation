...
- `Estante`: Unha colección de libros da usuaria. By default, every user has a `to-read`, `reading`, `stop-reading` and `read` shelf which are used to track reading progress.
