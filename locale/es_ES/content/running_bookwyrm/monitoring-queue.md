...
Puede haber casos en los que tus instancias se ralenticen. One option would be to inspect the queue to see whether some jobs hang. Lee para aprender cómo.
